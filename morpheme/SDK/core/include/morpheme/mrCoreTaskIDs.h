...
public:
  ...
  enum TaskIDs
  {
    ...
    MR_TASKID_BASIC_UNEVEN_TERRAIN_TRANSFORMS2,
    MR_TASKID_PREDICTIVE_UNEVEN_TERRAIN_IK_SETUP,
    MR_TASKID_PREDICTIVE_UNEVEN_TERRAIN_FOOT_LIFTING_TARGET,
    MR_TASKID_BASIC_UNEVEN_TERRAIN_TRANSFORMS3,
    MR_TASKID_BASIC_UNEVEN_TERRAIN_TRANSFORMS4,
...
#define MR_REGISTER_TRIANGLEBLENDTASKS(_regSPUElf) \
  ...
  MR_DISPATCHERREGISTERFN(TaskBasicUnevenTerrainTransforms, MR::CoreTaskIDs::MR_TASKID_BASIC_UNEVEN_TERRAIN_TRANSFORMS2) \
  MR_DISPATCHERREGISTERFN(TaskBasicUnevenTerrainTransforms, MR::CoreTaskIDs::MR_TASKID_BASIC_UNEVEN_TERRAIN_TRANSFORMS3) \
  MR_DISPATCHERREGISTERFN(TaskBasicUnevenTerrainTransforms, MR::CoreTaskIDs::MR_TASKID_BASIC_UNEVEN_TERRAIN_TRANSFORMS4)
#endif
